...
const NavbarFlowbite = () => {
  ...
  return (
    <>
     <nav className="bg-indigo-600 p-2 px-4 md:px-[100px]">
  <div className="container mx-auto flex justify-between items-center">
    <h1 className="text-white text-xl font-medium">Personal Blogging</h1>
    {isLoggedIn ? (
            ...
            <li>
              ...
              >
                <svg
                  ...
                  className="h-5 w-5 text-gray-600 transition-transform duration-300 ease-in-out transform hover:scale-110 hover:text-indigo-500"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M3 12l2-2m0 0l7-7 7 7m-9 2v12a2 2 0 002 2h4a2 2 0 002-2V12m-6 0l-2 2"
                  />
                </svg>
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M5.121 18.579A10.947 10.947 0 0112 15c2.96 0 5.639 1.19 7.879 3.579M15 10a3 3 0 11-6 0 3 3 0 016 0z"
                  />
                </svg>
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm1 7h-2v2h2v-2zm0-5h-2v3h2V10zm6 2v3h3v-3h-3z"
                  />
                </svg>
